...
class HydrodynamicsParametersPrivate
{
 public:
  HydrodynamicsParametersPrivate() :
    ...
    fSDrag(0.4),
    vRDrag(1.0),
    waterVelocity(CGAL::NULL_VECTOR)
  {}
...
//////////////////////////////////////////////////
//////////////////////////////////////////////////
cgal::Vector3 HydrodynamicsParameters::WaterVelocity() const
{
  return this->data->waterVelocity;
}
...
void HydrodynamicsParameters::SetFromMsg(const gz::msgs::Param_V& _msg)
{
  ...
  this->data->waterVelocity = ToVector3(Utilities::MsgParamVector3d(
      _msg, "water_velocity", ToGz(this->data->waterVelocity)));
}
...
void HydrodynamicsParameters::SetFromSDF(sdf::Element& _sdf)
{
  ...
  this->data->waterVelocity = ToVector3(Utilities::SdfParamVector3d(
      _sdf, "water_velocity", ToGz(this->data->waterVelocity)));
}
...
void HydrodynamicsParameters::DebugPrint() const
{
  ...
  gzmsg << "water_velocity:   " << ToGz(this->data->waterVelocity) << "\n";
}
...
)
{
  ...
  this->data->linVelocity = _linVelocity - this->data->params->WaterVelocity();
